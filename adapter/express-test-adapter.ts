...
import { isFunction, isNil, isObject, isString, isUndefined } from "@nestjs/common/utils/shared.utils";
 ...
 * @publicApi
 */
export class ExpressTestAdapter extends AbstractHttpAdapter<http.Server | https.Server> {
    ...
    public useBodyParser<Options = any>(type: any, rawBody: boolean, options?: Omit<Options, "verify">): this {
